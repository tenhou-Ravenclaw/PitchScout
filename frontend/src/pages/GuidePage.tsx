/**
 * 【GuidePage.tsx】
 * 役割：アプリの基本的な使い方やコツをユーザーに伝えるための「ご利用ガイド」ページです。
 * 特徴：ステップごとの解説、システム利用のヒント、推奨キーの読み方（凡例）を表示します。
 */
...
/** * ── 使い方のステップ定義 ──
 * 各ステップのアイコン、色、光り方（Glow）、テキスト内容をまとめて管理しています。
 */
const steps = [
  {
    icon: MicrophoneIcon,
    ...
    <div className="min-h-[calc(100vh-80px)] bg-transparent p-6 sm:p-8 overflow-hidden font-sans text-slate-300">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 sm:space-y-16 mb-16 relative">
          ...
          {steps.map((step, i) => {
            const isEven = i % 2 !== 0; // 偶数番目は右側に寄せる
            return (
              <div
                key={i}
...
// 無駄な再読み込みを防ぐために React.memo でラップしています
